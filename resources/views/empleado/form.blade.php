...
<input class="form-control" type="text"value="{{ isset( $empleado->ApellidoP)?$empleado->ApellidoP:old('ApellidoP') }}"  name="ApellidoP" id="ApellidoP">
</div>
<br>
<div class="form-group">
<label for="ApellidoM">ApellidoM</label>
<input class="form-control" type="text" value="{{ isset($empleado->ApellidoM)?$empleado->ApellidoM:old('ApellidoM') }}" name="ApellidoM" id="ApellidoM">
</div>
<br>
<div class="form-group">
